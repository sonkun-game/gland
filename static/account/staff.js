...
export async function getAllStaffsPaging(storeId, pageNum, departmentId) {
  let url = "https://api.random-otp.io.vn:8450/gland/api-account/all?storeId="+storeId+"&pageNum="+pageNum;
...
export async function createStaffsAll(storeId, departmentId) {
  ...
  return axios({
    method: 'post',
    url: 'https://api.random-otp.io.vn:8450/gland/api-authen/register',
    responseType: 'json',
    data: {
      username: username,
      password: password,
