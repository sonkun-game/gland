        ...
        <div class="login-action px-16 py-24">
            ...
            <form class="inline-block p-1 w-100" action="./" method="">
                ...
                <button type="button" @click="loginForm()"
                    class="w-100 text-white bg-slate-800 hover:bg-slate-700 focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Login</button>
            </form>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        loginForm() {
            ...
            axios({
                method: 'post',
                url: 'http://103.142.26.40:8080/Total/api/signing',
                responseType: 'json',
                data: {
