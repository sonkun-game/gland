<template>
  <div>
    ...
    <div class="flex">
      <div class="mr-2 pb-3">
        <<<<<<< HEAD <ShowModal :modalId="createMission.id" type="html"
        ...
        <div id="defaultModal" tabindex="-1" aria-hidden="true"
          ...
          <div class="relative w-full max-w-2xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <!-- Modal body -->
              <div>
                <InputField id="missionNameValue" label="Tên nhiệm vụ" styleClass="px-4 py-2"></InputField>
                <InputField id="desMissionValue" styleClass="px-4" label="Mô tả" typeInput="textarea"></InputField>
              </div>
              <!-- Modal footer -->
              ...
              <div class="flex justify-end items-center p-6 space-x-2 border-gray-200 rounded-b dark:border-gray-600">
                ...
                <button :data-modal-hide="createMission.id" @click="createMissionAll(storeId)"
                  class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Lưu</button>
              </div>
              </ModalContainer>
              </ShowModal>
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                  ...
                  <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="px-6 pt-2 space-y-6">
                      <div>
                        <label for="chooseDepartment"
                          class="block text-sm font-semibold text-gray-900 dark:text-white">Chọn
                          nhiệm vụ</label>
                        <div class=" pt-2">
                        ...
                        <details class="" open>
                          ...
                          <p class="px-5 py-2">
                            ...
                            <label for="checkbox-accounts"
                              class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tài
                              khoản</label>
                          </p>
                          <p class="px-5 py-2">
                          ...
                          <p class="px-5 py-2">
                            ...
                            <label for="checkbox-decent"
                              class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Phòng
                              ban</label>
                          </p>
                        </details>
                      </div>
          ...
          <!-- Table -->
          <div>
            <CrudTable style-class="w-full text-sm dark:text-gray-400" :totalPage="missionList.totalPage"
              :currentPage="1">
              <Thead>
                          ...
                          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6">
                              <div class="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                  <label for="localtion"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Vị
                                    trí</label>
                                  <select id="localtion"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-xs rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    <option selected></option>
