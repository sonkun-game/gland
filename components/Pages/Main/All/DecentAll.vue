        ...
        <tbody>
          <Row styleClass="bg-white border-b" v-for="(item, index) in departList.table.body" :key="index">
            ...
            <Cell styleClass="px-2 py-3 flex">
              <div>
                <button data-modal-target="editModalDepart" data-modal-toggle="editModalDepart"
                ...
                <!-- Main modal -->
                <div id="editModalDepart" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="flex items-start justify-between p-4 rounded-t dark:border-gray-600">
                        ...
                        <button type="button"
                          ...
                          data-modal-hide="editModalDepart">
              ...
              <div>
                <button data-modal-target="deleteDepart" data-modal-toggle="deleteDepart"
                ...
                <!-- Main modal -->
                <div id="deleteDepart" tabindex="-1" aria-hidden="true"
                  class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                  <div class="relative w-full max-w-3xl max-h-full">
                    <!-- Modal content -->
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
